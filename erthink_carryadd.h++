...
template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
...
template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t add_carry(const T base, const T addend, T &sum, const uint_least8_t carry_in) noexcept {
  T midterm;
...
template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t addcarry_first(const T &base, const T &addend, T &sum) noexcept {
  return add_carry<T>(base, addend, sum);
}

template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t addcarry_next(const uint_least8_t carry_in, const T &base, const T &addend, T &sum) noexcept {
  return add_carry<T>(base, addend, sum, carry_in);
}

template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline void addcarry_last(const uint_least8_t carry_in, const T &base, const T &addend, T &sum) noexcept {
...
template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t sub_borrow(const T base, const T subtrahend, T &diff) noexcept {
...
template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t sub_borrow(const T base, const T subtrahend, T &diff, const uint_least8_t borrow_in) noexcept {
  T midterm;
...
template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t subborrow_first(const T &base, const T &subtrahend, T &diff) noexcept {
  return sub_borrow<T>(base, subtrahend, diff);
}

template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline uint_least8_t subborrow_next(const uint_least8_t borrow_in, const T &base, const T &subtrahend,
                                    T &diff) noexcept {
  return sub_borrow<T>(base, subtrahend, diff, borrow_in);
}

template <typename T, typename = typename erthink::enable_if_t<std::is_unsigned<T>::value>>
inline void subborrow_last(const uint_least8_t borrow_in, const T &base, const T &subtrahend, T &diff) noexcept {
...
template <>
inline uint_least8_t add_carry<unsigned long long>(const unsigned long long base, const unsigned long long addend,
...
template <>
inline uint_least8_t add_carry<unsigned long>(const unsigned long base, const unsigned long addend,
...
template <>
inline uint_least8_t add_carry<unsigned long>(const unsigned long base, const unsigned long addend, unsigned long &sum,
...
template <>
inline uint_least8_t add_carry<unsigned>(const unsigned base, const unsigned addend, unsigned &sum) noexcept {
  unsigned carry_out;
...
template <>
inline uint_least8_t add_carry<unsigned>(const unsigned base, const unsigned addend, unsigned &sum,
                                         uint_least8_t carry_in) noexcept {
  unsigned carry_out;
...
template <>
inline uint_least8_t sub_borrow<unsigned long long>(const unsigned long long base, const unsigned long long subtrahend,
...
template <>
inline uint_least8_t sub_borrow<unsigned long>(const unsigned long base, const unsigned long subtrahend,
...
template <>
inline uint_least8_t sub_borrow<unsigned long>(const unsigned long base, const unsigned long subtrahend,
                                               unsigned long &diff, uint_least8_t borrow_in) noexcept {
  unsigned long borrow_out;
...
template <>
inline uint_least8_t sub_borrow<unsigned>(const unsigned base, const unsigned subtrahend, unsigned &diff) noexcept {
  unsigned borrow_out;
...
template <>
inline uint_least8_t sub_borrow<unsigned>(const unsigned base, const unsigned subtrahend, unsigned &diff,
...
template <>
inline uint_least8_t add_carry<uint64_t>(const uint64_t base, const uint64_t addend, uint64_t &sum) noexcept {
  sum = base + addend;
  return __builtin_e2k_addcd_c(base, addend, 0);
}

template <>
inline uint_least8_t add_carry<uint64_t>(const uint64_t base, const uint64_t addend, uint64_t &sum,
                                         uint_least8_t carry_in) noexcept {
...
template <>
inline uint_least8_t sub_borrow<uint64_t>(const uint64_t base, const uint64_t subtrahend, uint64_t &diff) noexcept {
  diff = base - subtrahend;
  return __builtin_e2k_subcd_c(base, subtrahend, 0);
}

template <>
inline uint_least8_t sub_borrow<uint64_t>(const uint64_t base, const uint64_t subtrahend, uint64_t &diff,
                                          uint_least8_t borrow_in) noexcept {
...
#if !defined(__clang__) && ((defined(_M_IX86) && _MSC_VER >= 1915 /* LY: workaround for SSA-optimizer bug */) ||       \
                            defined(_M_X64) || defined(_M_AMD64))
#pragma intrinsic(_addcarry_u32)
template <>
inline uint_least8_t add_carry<uint32_t>(const uint32_t base, const uint32_t addend, uint32_t &sum) noexcept {
  return _addcarry_u32(0, base, addend, &sum);
}

template <>
inline uint_least8_t add_carry<uint32_t>(const uint32_t base, const uint32_t addend, uint32_t &sum,
                                         uint_least8_t carry_in) noexcept {
...
template <>
inline uint_least8_t sub_borrow<uint32_t>(const uint32_t base, const uint32_t subtrahend, uint32_t &diff) noexcept {
  return _subborrow_u32(0, base, subtrahend, &diff);
}

template <>
inline uint_least8_t sub_borrow<uint32_t>(const uint32_t base, const uint32_t subtrahend, uint32_t &diff,
                                          uint_least8_t borrow_in) noexcept {
...
inline uint_least8_t add_carry<uint64_t>(const uint64_t base, const uint64_t addend, uint64_t &sum) noexcept {
  ...
  return add_carry<uint32_t>(
      base_32h, addend_32h, sum32_ptr[__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__],
      add_carry<uint32_t>(base_32l, addend_32l, sum32_ptr[__BYTE_ORDER__ != __ORDER_LITTLE_ENDIAN__]));
}
...
inline uint_least8_t add_carry<uint64_t>(const uint64_t base, const uint64_t addend, uint64_t &sum,
  ...
  return add_carry<uint32_t>(
      base_32h, addend_32h, sum32_ptr[__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__],
      add_carry<uint32_t>(base_32l, addend_32l, sum32_ptr[__BYTE_ORDER__ != __ORDER_LITTLE_ENDIAN__], carry_in));
}
...
inline uint_least8_t sub_borrow<uint64_t>(const uint64_t base, const uint64_t subtrahend, uint64_t &diff) noexcept {
  ...
  return sub_borrow<uint32_t>(
      base_32h, subtrahend_32h, diff32_ptr[__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__],
      sub_borrow<uint32_t>(base_32l, subtrahend_32l, diff32_ptr[__BYTE_ORDER__ != __ORDER_LITTLE_ENDIAN__]));
}
...
inline uint_least8_t sub_borrow<uint64_t>(const uint64_t base, const uint64_t subtrahend, uint64_t &diff,
  ...
  return sub_borrow<uint32_t>(
      base_32h, subtrahend_32h, diff32_ptr[__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__],
      sub_borrow<uint32_t>(base_32l, subtrahend_32l, diff32_ptr[__BYTE_ORDER__ != __ORDER_LITTLE_ENDIAN__], borrow_in));
}
#endif /* ERTHINK_ARCH_BITS < 64 */

//------------------------------------------------------------------------------

inline uint_least8_t add64carry_first(const uint64_t &base, const uint64_t &addend, uint64_t *sum) noexcept {
  return addcarry_first<uint64_t>(base, addend, *sum);
}

inline uint_least8_t add64carry_next(const uint_least8_t carry_in, const uint64_t &base, const uint64_t &addend,
                                     uint64_t *sum) noexcept {
  return addcarry_next<uint64_t>(carry_in, base, addend, *sum);
}

inline void add64carry_last(const uint_least8_t carry_in, const uint64_t &base, const uint64_t &addend,
                            uint64_t *sum) noexcept {
  return addcarry_last<uint64_t>(carry_in, base, addend, *sum);
}

inline uint_least8_t sub64borrow_first(const uint64_t &base, const uint64_t &subtrahend, uint64_t *diff) noexcept {
  return subborrow_first<uint64_t>(base, subtrahend, *diff);
}

inline uint_least8_t sub64borrow_next(const uint_least8_t borrow_in, const uint64_t &base, const uint64_t &subtrahend,
                                      uint64_t *diff) noexcept {
  return subborrow_next<uint64_t>(borrow_in, base, subtrahend, *diff);
}

inline void sub64borrow_last(const uint_least8_t borrow_in, const uint64_t &base, const uint64_t &subtrahend,
                             uint64_t *diff) noexcept {
